...
Runs the full pipeline once per (sample size n, seed), saves a CSV with the
recovered dimensions, |p - p_hat|, and the Jaccard score for shared-coordinate
identification (Theorem 1, Schur-complement form). Optionally saves a plot.
"""
...
# Make `crl_sim` importable when this script is run directly from anywhere.
